...
// ClosedLimit is the cap that was sent to taskmgr; it is used to determine whether
...
type Inputs struct {
	...
	ClosedLimit   int // the cap that was sent to taskmgr; used to determine row-list truncation
...
// it is verified by the sort-parity test (izds) against real taskmgr data.
