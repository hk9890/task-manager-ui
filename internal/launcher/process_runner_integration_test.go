...
// TestExecProcessRunnerStartsProcess verifies that runner.Run successfully
// executes a real subprocess (sleep) without error.
...
// TestExecProcessRunnerPreservesParentEnvWhenLauncherEnvSet verifies that
