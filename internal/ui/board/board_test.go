				...
				Columns: []Column{
					{
						Title: "Ready",
						Rows: []domain.IssueSummary{
							{ID: "task-manager-ui-u5s", Title: "Redesign board rows and metadata for compact scanability", Type: "task", Status: "open", Priority: 0},
							{ID: "task-manager-ui-1ri", Title: "Dashboard UX runtime harness and width matrix assertions", Type: "feature", Status: "in_progress", Priority: 1},
							{ID: "task-manager-ui-y3x", Title: "Runtime bug: board rows hide readiness/type signals", Type: "bug", Status: "blocked", Priority: 0},
						},
						SelectedRow:  0,
						Total:        7,
						TotalIsExact: true,
					},
					{
						Title: "Blocked",
						Rows: []domain.IssueSummary{
							{ID: "task-manager-ui-9oo", Title: "Acceptance review board UX regressions and fixes", Type: "task", Status: "blocked", Priority: 0},
						},
						SelectedRow:  -1,
						Total:        3,
						TotalIsExact: true,
					},
					{
						Title: "Recent Work",
						Rows: []domain.IssueSummary{
							{ID: "task-manager-ui-j34", Title: "Remove large sidebar from board view", Type: "task", Status: "closed", Priority: 1},
						},
						SelectedRow:  -1,
						Total:        42,
						TotalIsExact: true,
					},
					{
						Title: "Assigned",
						Rows: []domain.IssueSummary{
							{ID: "task-manager-ui-7qz", Title: "Preserve four-column grouping in dashboard renderer", Type: "epic", Status: "in_progress", Priority: 1},
						},
						SelectedRow:  -1,
						Total:        5,
						TotalIsExact: true,
...
func TestRenderBoardResponsiveWideGolden(t *testing.T) {
	...
	state := State{
		...
		Columns: []Column{
			...
			{Title: "Blocked", Rows: []domain.IssueSummary{{ID: "task-manager-ui-yze.4.5", Title: "Add editor and launcher integration tests", Type: "bug", Status: "blocked", Priority: 1}}, SelectedRow: 0, Total: 2, TotalIsExact: true},
			{Title: "Recent Work", Rows: []domain.IssueSummary{{ID: "task-manager-ui-yze.4", Title: "Deliver editor and launcher flows", Type: "task", Status: "closed", Priority: 1}}, SelectedRow: -1, Total: 15, TotalIsExact: true},
			{Title: "Assigned", Rows: []domain.IssueSummary{{ID: "task-manager-ui-yze.1", Title: "Acceptance Review: Task Manager UI v1 standalone product", Type: "epic", Status: "open", Priority: 1}}, SelectedRow: -1, Total: 3, TotalIsExact: true},
		},
	}
